...
hkbPoweredRagdollControlsModifier::hkbPoweredRagdollControlsModifier(BehaviorFile *parent, long ref)
...
bool hkbPoweredRagdollControlsModifier::link(){
    ...
    ptr = getParentFile()->findHkxObject(boneWeights.getReference());
    if (ptr){
