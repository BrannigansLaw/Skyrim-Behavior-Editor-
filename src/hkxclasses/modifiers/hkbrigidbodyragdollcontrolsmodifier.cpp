...
bool hkbRigidBodyRagdollControlsModifier::write(HkxXMLWriter *writer){
    ...
    if (!getIsWritten()){
        ...
        writer->writeLine(writer->object, true);
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("hierarchyGain"), QString::number(hierarchyGain));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("velocityDamping"), QString::number(velocityDamping));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("accelerationGain"), QString::number(accelerationGain));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("velocityGain"), QString::number(velocityGain));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("positionGain"), QString::number(positionGain));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("positionMaxLinearVelocity"), QString::number(positionMaxLinearVelocity));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("positionMaxAngularVelocity"), QString::number(positionMaxAngularVelocity));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("snapGain"), QString::number(snapGain));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("snapMaxLinearVelocity"), QString::number(snapMaxLinearVelocity));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("snapMaxAngularVelocity"), QString::number(snapMaxAngularVelocity));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("snapMaxLinearDistance"), QString::number(snapMaxLinearDistance));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("snapMaxAngularDistance"), QString::number(snapMaxAngularDistance));
        writer->writeLine(writer->object, false);
        writer->writeLine(writer->parameter, false);
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("durationToBlend"), QString::number(durationToBlend));
        writer->writeLine(writer->object, false);
        writer->writeLine(writer->parameter, false);
        if (bones.data()){
