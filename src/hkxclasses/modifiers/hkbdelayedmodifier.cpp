...
hkbDelayedModifier::hkbDelayedModifier(BehaviorFile *parent, long ref)
...
int hkbDelayedModifier::addChildrenToList(QList <HkxObjectExpSharedPtr> & list, bool reverseOrder){
