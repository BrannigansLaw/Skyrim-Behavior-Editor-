...
BSComputeAddBoneAnimModifier::BSComputeAddBoneAnimModifier(BehaviorFile *parent, long ref)
...
bool BSComputeAddBoneAnimModifier::evaulateDataValidity(){  //Check bone index???
