...
bool BSLimbIKModifier::write(HkxXMLWriter *writer){
    ...
    if (!getIsWritten()){
        ...
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("limitAngleDegrees"), getDoubleAsString(limitAngleDegrees));
        ...
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("gain"), getDoubleAsString(gain));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("boneRadius"), getDoubleAsString(boneRadius));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("castOffset"), getDoubleAsString(castOffset));
