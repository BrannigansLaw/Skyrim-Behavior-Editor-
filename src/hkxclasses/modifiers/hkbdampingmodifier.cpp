...
hkbDampingModifier::hkbDampingModifier(BehaviorFile *parent, long ref)
...
bool hkbDampingModifier::write(HkxXMLWriter *writer){
    ...
    if (!getIsWritten()){
        ...
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("kP"), getDoubleAsString(kP));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("kI"), getDoubleAsString(kI));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("kD"), getDoubleAsString(kD));
        ...
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("rawValue"), getDoubleAsString(rawValue));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("dampedValue"), getDoubleAsString(dampedValue));
        ...
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("errorSum"), getDoubleAsString(errorSum));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("previousError"), getDoubleAsString(previousError));
