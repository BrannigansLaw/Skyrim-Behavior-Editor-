...
hkbKeyframeBonesModifier::hkbKeyframeBonesModifier(BehaviorFile *parent, long ref)
...
bool hkbKeyframeBonesModifier::link(){
    ...
    HkxObjectExpSharedPtr *ptr = getParentFile()->findHkxObject(keyframedBonesList.getReference());
    if (ptr){
