...
hkbEventsFromRangeModifier::hkbEventsFromRangeModifier(BehaviorFile *parent, long ref)
...
bool hkbEventsFromRangeModifier::link(){
    ...
    HkxObjectExpSharedPtr *ptr = getParentFile()->findHkxObject(eventRanges.getReference());
    if (ptr){
