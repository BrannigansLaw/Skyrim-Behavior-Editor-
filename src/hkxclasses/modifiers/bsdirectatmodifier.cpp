...
BSDirectAtModifier::BSDirectAtModifier(BehaviorFile *parent, long ref)
...
bool BSDirectAtModifier::write(HkxXMLWriter *writer){
    ...
    if (!getIsWritten()){
        ...
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("limitHeadingDegrees"), getDoubleAsString(limitHeadingDegrees));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("limitPitchDegrees"), getDoubleAsString(limitPitchDegrees));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("offsetHeadingDegrees"), getDoubleAsString(offsetHeadingDegrees));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("offsetPitchDegrees"), getDoubleAsString(offsetPitchDegrees));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("onGain"), getDoubleAsString(onGain));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("offGain"), getDoubleAsString(offGain));
        ...
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("directAtCameraX"), getDoubleAsString(directAtCameraX));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("directAtCameraY"), getDoubleAsString(directAtCameraY));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("directAtCameraZ"), getDoubleAsString(directAtCameraZ));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("active"), getBoolAsString(active));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("currentHeadingOffset"), getDoubleAsString(currentHeadingOffset));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("currentPitchOffset"), getDoubleAsString(currentPitchOffset));
