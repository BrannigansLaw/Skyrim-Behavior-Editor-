...
hkbGeneratorTransitionEffect::hkbGeneratorTransitionEffect(BehaviorFile *parent, long ref)
...
bool hkbGeneratorTransitionEffect::link(){
    ...
    HkxObjectExpSharedPtr *ptr = getParentFile()->findGenerator(transitionGenerator.getReference());
    if (ptr){
