...
bool hkbPoseMatchingGenerator::write(HkxXMLWriter *writer){
    ...
    if (!getIsWritten()){
        ...
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("blendSpeed"), getDoubleAsString(blendSpeed));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("minSpeedToSwitch"), getDoubleAsString(minSpeedToSwitch));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("minSwitchTimeNoError"), getDoubleAsString(minSwitchTimeNoError));
        writer->writeLine(writer->parameter, QStringList(writer->name), QStringList("minSwitchTimeFullError"), getDoubleAsString(minSwitchTimeFullError));
