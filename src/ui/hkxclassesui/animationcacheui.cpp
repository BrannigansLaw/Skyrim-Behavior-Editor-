...
void CacheClipWidget::loadData(AnimCacheClipInfo *data){
    if (data){
        ...
        (qFatal("CacheClipWidget::loadData(): The data is NULL!!"));
    }
}
      ...
      removeCacheButton(new QPushButton("Remove Selected Cache File"))
{
    ...
    cacheFiles->setEditTriggers(QAbstractItemView::DoubleClicked);
...
void AnimationCacheUI::loadData(ProjectFile *project){
    if (project){
        ...
        (qFatal("AnimationCacheUI::loadData(): The data is NULL!!"));
    }
}
...
void AnimationCacheUI::viewSelectedFile(int row, int column){
    if (bsData){
        ...
        (qFatal("AnimationCacheUI::viewSelectedFile(): The data is NULL!!"));
    }
}
...
void AnimationCacheUI::addCacheFile(){
    if (bsData){
        ...
        (qFatal("AnimationCacheUI::addCacheFile(): The data is NULL!!"));
    }
}
...
void AnimationCacheUI::removeCacheFile(){
    if (bsData){
        ...
        (qFatal("AnimationCacheUI::removeCacheFile(): The data is NULL!!"));
    }
}
