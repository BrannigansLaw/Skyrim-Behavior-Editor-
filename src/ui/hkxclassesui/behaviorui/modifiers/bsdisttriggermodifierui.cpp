      ...
      triggerEventPayload(new QLineEdit)
{
    ...
    table->setItem(TRIGGER_EVENT_ID_ROW, TYPE_COLUMN, new TableWidgetItem("hkEvent", Qt::AlignCenter));
    table->setItem(TRIGGER_EVENT_ID_ROW, BINDING_COLUMN, new TableWidgetItem("N/A", Qt::AlignCenter));
    table->setItem(TRIGGER_EVENT_ID_ROW, VALUE_COLUMN, new TableWidgetItem(BINDING_ITEM_LABEL+"NONE", Qt::AlignLeft | Qt::AlignVCenter, QColor(Qt::lightGray), QBrush(Qt::black), VIEW_EVENTS_TABLE_TIP));
    table->setItem(TRIGGER_EVENT_PAYLOAD_ROW, NAME_COLUMN, new TableWidgetItem("triggerEventPayload"));
    table->setItem(TRIGGER_EVENT_PAYLOAD_ROW, TYPE_COLUMN, new TableWidgetItem("hkEventPayload", Qt::AlignCenter));
...
void BSDistTriggerModifierUI::connectToTables(GenericTableWidget *variables, GenericTableWidget *properties, GenericTableWidget *events){
    if (variables && properties && events){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::connectToTables(): One or more arguments are NULL!!"))
    }
}
...
void BSDistTriggerModifierUI::loadData(HkxObject *data){
    ...
    if (data){
        if (data->getSignature() == BS_DIST_TRIGGER_MODIFER){
            ...
            CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::loadData(): The data is an incorrect type!!"));
        }
    }else{
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::loadData(): The data is NULL!!"));
    }
    connectSignals();
}
...
void BSDistTriggerModifierUI::setName(){
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::setName(): The data is NULL!!"));
    }
}
...
void BSDistTriggerModifierUI::setTargetPosition(){
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::settargetPosition(): The data is NULL!!"));
    }
}
...
void BSDistTriggerModifierUI::setDistance(){
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::setdistance(): The data is NULL!!"));
    }
}
...
void BSDistTriggerModifierUI::setDistanceTrigger(){
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::setdistanceTrigger(): The data is NULL!!"));
    }
}
...
void BSDistTriggerModifierUI::setTriggerEventPayload(){
    ...
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::setTriggerEventPayload(): The data is NULL!!"));
    }
}
...
void BSDistTriggerModifierUI::viewSelected(int row, int column){
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::viewSelected(): The 'bsData' pointer is NULL!!"))
    }
}
...
void BSDistTriggerModifierUI::selectTableToView(bool viewisProperty, const QString & path){
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::selectTableToView(): The data is NULL!!"));
    }
}
...
void BSDistTriggerModifierUI::eventRenamed(const QString & name, int index){
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::eventRenamed(): The data is NULL!!"));
    }
}
...
void BSDistTriggerModifierUI::variableRenamed(const QString & name, int index){
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::variableRenamed(): The 'bsData' pointer is NULL!!"))
    }
}
...
bool BSDistTriggerModifierUI::setBinding(int index, int row, const QString &variableName, const QString &path, hkVariableType type, bool isProperty){
    ...
    if (bsData){
        if (index == 0){
            ...
            if (isProperty){
                if (!varBind->addBinding(path, variableName, index - 1, hkbVariableBindingSet::hkBinding::BINDING_TYPE_CHARACTER_PROPERTY)){
                    CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::setBinding(): The attempt to add a binding to this object's hkbVariableBindingSet failed!!"));
                }
            }else{
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::setBinding(): The data is NULL!!"));
    }
    return true;
}
...
void BSDistTriggerModifierUI::setBindingVariable(int index, const QString &name){
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::setBindingVariable(): The data is NULL!!"));
    }
}
...
void BSDistTriggerModifierUI::loadBinding(int row, int colunm, hkbVariableBindingSet *varBind, const QString &path){
    if (bsData){
        ...
        CRITICAL_ERROR_MESSAGE(QString("BSDistTriggerModifierUI::loadBinding(): The data is NULL!!"));
    }
}
