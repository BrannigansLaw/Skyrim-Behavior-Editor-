      ...
      flagAbutEndState(new QCheckBox)
{
    ...
    table->item(TRIGGER_INTERVAL_ENTER_EVENT_ID_ROW, VALUE_COLUMN)->setBackgroundColor(QColor(Qt::gray));
    ...
    table->item(TRIGGER_INTERVAL_EXIT_EVENT_ID_ROW, VALUE_COLUMN)->setBackgroundColor(QColor(Qt::gray));
    ...
    table->item(INITIATE_INTERVAL_ENTER_EVENT_ID_ROW, VALUE_COLUMN)->setBackgroundColor(QColor(Qt::gray));
    ...
    table->item(INITIATE_INTERVAL_EXIT_EVENT_ID_ROW, VALUE_COLUMN)->setBackgroundColor(QColor(Qt::gray));
    ...
    table->item(TRANSITION_ROW, VALUE_COLUMN)->setBackgroundColor(QColor(Qt::gray));
    ...
    table->item(EVENT_ID_ROW, VALUE_COLUMN)->setBackgroundColor(QColor(Qt::gray));
