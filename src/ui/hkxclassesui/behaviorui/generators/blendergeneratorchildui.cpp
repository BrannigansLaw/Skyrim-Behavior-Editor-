...
QStringList BlenderGeneratorChildUI::headerLabels1 = {
    "Name",
    "Type",
    "Value"
};
...
void BlenderGeneratorChildUI::loadData(hkbFootIkDriverInfoLeg *data){
    if (data){
...
void BlenderGeneratorChildUI::setKneeAxisLS(){
    if (bsData){
...
void BlenderGeneratorChildUI::setFootEndLS(){
    if (bsData){
...
void BlenderGeneratorChildUI::setFootPlantedAnkleHeightMS(){
    if (bsData){
...
void BlenderGeneratorChildUI::setFootRaisedAnkleHeightMS(){
    if (bsData){
...
void BlenderGeneratorChildUI::setMaxAnkleHeightMS(){
    if (bsData){
...
void BlenderGeneratorChildUI::setMinAnkleHeightMS(){
    if (bsData){
...
void BlenderGeneratorChildUI::setMaxKneeAngleDegrees(){
    if (bsData){
...
void BlenderGeneratorChildUI::setMinKneeAngleDegrees(){
    if (bsData){
...
void BlenderGeneratorChildUI::setMaxAnkleAngleDegrees(){
    if (bsData){
...
void BlenderGeneratorChildUI::setHipIndex(int index){
    if (bsData){
...
void BlenderGeneratorChildUI::setKneeIndex(int index){
    if (bsData){
...
void BlenderGeneratorChildUI::setAnkleIndex(int index){
    if (bsData){
...
void BlenderGeneratorChildUI::loadBoneList(QStringList & bones){
    bones.prepend("None");
    hipIndex->clear();
