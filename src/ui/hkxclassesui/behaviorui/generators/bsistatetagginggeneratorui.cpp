      ...
      iPriorityBind(new ComboBox)
{
    ...
    table->setItem(1, 0, new TableWidgetItem("pDefaultGenerator"));
    table->setItem(1, 1, new TableWidgetItem("hkbGenerator"));
    table->setCellWidget(1, 2, pDefaultGenerator);
    table->setItem(2, 0, new TableWidgetItem("iStateToSetAs"));
    ...
    table->setItem(3, 0, new TableWidgetItem("iPriority"));
    table->setItem(3, 1, new TableWidgetItem("hkInt32"));
